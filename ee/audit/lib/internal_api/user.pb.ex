defmodule InternalApi.User.Favorite.Kind do
  ...
  @type t :: integer | :PROJECT | :DASHBOARD
...
defmodule InternalApi.User.DescribeResponse.RepoScope do
  @moduledoc false
  use Protobuf, enum: true, syntax: :proto3
  @type t :: integer | :NONE | :PUBLIC | :PRIVATE
...
defmodule InternalApi.User.RepositoryProvider.Scope do
  @moduledoc false
  use Protobuf, enum: true, syntax: :proto3
  @type t :: integer | :NONE | :EMAIL | :PUBLIC | :PRIVATE
...
defmodule InternalApi.User.Favorite do
  ...
  @type t :: %__MODULE__{
          ...
          kind: InternalApi.User.Favorite.Kind.t()
        }
...
defmodule InternalApi.User.DescribeResponse do
  ...
  @type t :: %__MODULE__{
          ...
          company: String.t(),
          blocked_at: Google.Protobuf.Timestamp.t() | nil,
          repository_scopes: InternalApi.User.RepositoryScopes.t() | nil,
...
defmodule InternalApi.User.RepositoryProvider do
  ...
  @type t :: %__MODULE__{
          type: InternalApi.User.RepositoryProvider.Type.t(),
          scope: InternalApi.User.RepositoryProvider.Scope.t(),
          login: String.t(),
          uid: String.t()
        }
...
defmodule InternalApi.User.RepositoryScopes.RepositoryScope do
  ...
  @type t :: %__MODULE__{
          scope: InternalApi.User.RepositoryScopes.RepositoryScope.Scope.t(),
          login: String.t(),
          uid: String.t()
        }
...
defmodule InternalApi.User.RepositoryScopes do
  ...
  @type t :: %__MODULE__{
          github: InternalApi.User.RepositoryScopes.RepositoryScope.t() | nil,
          bitbucket: InternalApi.User.RepositoryScopes.RepositoryScope.t() | nil
        }
...
defmodule InternalApi.User.DescribeByRepositoryProviderRequest do
  ...
  @type t :: %__MODULE__{
          provider: InternalApi.User.RepositoryProvider.t() | nil
        }
...
defmodule InternalApi.User.RefreshRepositoryProviderResponse do
  ...
  @type t :: %__MODULE__{
          user_id: String.t(),
          repository_provider: InternalApi.User.RepositoryProvider.t() | nil
        }
...
defmodule InternalApi.User.User do
  ...
  @type t :: %__MODULE__{
          ...
          created_at: Google.Protobuf.Timestamp.t() | nil,
          repository_providers: [InternalApi.User.RepositoryProvider.t()],
          visited_at: Google.Protobuf.Timestamp.t() | nil,
          single_org_user: boolean,
          org_id: String.t(),
          creation_source: InternalApi.User.User.CreationSource.t(),
          deactivated: boolean
        }
...
defmodule InternalApi.User.FavoriteCreated do
  ...
  @type t :: %__MODULE__{
          favorite: InternalApi.User.Favorite.t() | nil,
          timestamp: Google.Protobuf.Timestamp.t() | nil
        }
