defmodule Guard.SessionTest do
  use ExUnit.Case, async: true

  describe "serialize_into_session" do
    test "serialize user into session" do
      user = %Guard.FrontRepo.User{id: "98b29afb-2450-426b-b5b3-8ef55b3719e1", salt: "pepper"}

      assert {"warden.user.user.key", [["98b29afb-2450-426b-b5b3-8ef55b3719e1"], "pepper"]} =
               Guard.Session.serialize_into_session(user)
    end
  end
  ...
  describe "decrypt_cookie" do
    test "decrypt old rails cookie" do
      ...
      assert %{
             ...
             } = Guard.Session.decrypt_cookie(cookie)
    end
  ...
  describe "encrypt_cookie" do
    test "encrypted cookie can be decrypted" do
      ...
      assert Guard.Session.encrypt_cookie(cookie) |> Guard.Session.decrypt_cookie() == cookie
    end
  end
end
