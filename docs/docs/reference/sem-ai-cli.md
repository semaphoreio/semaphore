...
### sem-ai dashboard list {#dashboard-list}

List dashboards:

```shell
sem-ai dashboard list
```

### sem-ai dashboard show {#dashboard-show}

Show dashboard details:

```shell
sem-ai dashboard show <name>
```

### sem-ai dashboard create {#dashboard-create}

Create a dashboard:

```shell
sem-ai dashboard create <name>
```

### sem-ai dashboard delete {#dashboard-delete}

Delete a dashboard:

```shell
sem-ai dashboard delete <name>
```
