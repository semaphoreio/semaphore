...
export const ZeroState = () => {
  return (
    <div className="bg-washed-yellow br3 pa3 pa4-m ba b--black-075 w-100 mt2">
      ...
      <p className="mb4 measure pr6-ns">
        Reading through thousands lines of logs isn’t fun. <span className="bg-lightest-red ph1 br3">Spot failed tests in seconds</span>,
        instead of minutes!
      </p>
          ...
          <div className="bl b--lighter-gray pl3 ml1 mt2">
            <div className="mb3">
              <div className="flex justify-between bg-red white bt b--white">
                <div className="flex-auto ph2">test users are able to log in</div>
              ...
              <div className="overflow-auto ph2 pv1 bl br bb b--red bw1" style="max-height: 480px;">
                <pre className="f6 mb0">Error: Button with text &quot;Log In&quot; not found tests/users/login.js</pre>
              </div>
            </div>

            <div className="flex justify-between bg-lightest-red bt b--white hover-white hover-bg-red pointer">
              <div className="flex-auto ph2">test users can log out</div>
            ...
            <div className="flex justify-between bg-lightest-green bt b--white hover-white hover-bg-green pointer">
              <div className="flex-auto ph2">test users can edit their profile</div>
              <div className="bg-green white bl b--white f6 code flex items-center ph2">
                00:11<span className="o-60">.023</span>
              </div>
            </div>
            <div className="flex justify-between bg-lightest-green bt b--white hover-white hover-bg-green pointer">
              <div className="flex-auto ph2">test users can open the main dashboard</div>
              <div className="bg-green white bl b--white f6 code flex items-center ph2">
                00:02<span className="o-60">.930</span>
              </div>
            </div>
            <div className="flex justify-between bg-lightest-green bt b--white hover-white hover-bg-green pointer">
              <div className="flex-auto ph2">test users can change their names</div>
              <div className="bg-green white bl b--white f6 code flex items-center ph2">
            ...
            <div>
              ...
              <div className="flex mb2">
                ...
                <div className="flex-auto pl3 nt1">
                  ...
                  <p className="measure-wide">
                    Add <code className="f6 bg-white ph1 br2 ba b--black-20">test-results publish results.xml</code> to all jobs that run
                    tests on Semaphore
                  </p>
                </div>
              </div>
              <div className="flex mb2">
                ...
                <div className="flex-auto pl3 nt1">
                  ...
                  <p className="measure-wide">
                    Once your pipeline is finished, merge the results and generate report using{` `}
                    <code className="f6 bg-white ph1 br2 ba b--black-20">test-results gen-pipeline-report</code> and you’re done!
                  </p>
                  ...
                  <div className="mt4">
                    ...
                    <p className="mb0">
                      <a
                        href="https://docs.semaphoreci.com/essentials/test-summary/#setting-up-test-reports"
                        target="_blank"
                        className="btn btn-secondary"
                        rel="noreferrer"
                      >
                        Docs: Setting up Test Reports
                      </a>
                    </p>
                  </div>
                </div>
