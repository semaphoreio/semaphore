...
ignore {
	deny_vulnerability_ids := {
		...
		"CVE-2026-46597",
		#
		# go.opentelemetry.io/otel v1.39.0 — CVE-2026-29181: CPU/allocation amplification via
		# many baggage: header lines. Inbound traffic is from cluster peers only;
		# availability-only. Fixed in otel 1.41.0, bump tracked on the dep-bump branch.
		"CVE-2026-29181"
	}
