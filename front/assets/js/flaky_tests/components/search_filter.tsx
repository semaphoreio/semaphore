                ...
                anchor={
                  <div
                    className={`btn btn-secondary ph2 flex items-center ${
                      state.currentFilter ? `br0` : `br3 br--right`
                    }`}
                  >
            ...
            <toolbox.Tooltip
              anchor={
                <toolbox.Popover
                  anchor={
                    notificationSignal ? (
                      <button className="material-symbols-outlined f5 b btn pointer pa1 btn-primary ml2">
                        notifications_active
                      </button>
                    ) : (
                      <button className="material-symbols-outlined f5 b btn pointer pa1 btn-secondary ml2">
                        notifications
                      </button>
                    )
                  }
