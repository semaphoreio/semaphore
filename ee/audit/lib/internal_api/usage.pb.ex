defmodule InternalApi.Usage.SeatOrigin do
  ...
  @type t ::
          integer
          | :SEAT_ORIGIN_UNSPECIFIED
          | :SEAT_ORIGIN_SEMAPHORE
          | :SEAT_ORIGIN_GITHUB
          | :SEAT_ORIGIN_BITBUCKET
          | :SEAT_ORIGIN_GITLAB
...
defmodule InternalApi.Usage.SeatStatus do
  ...
  @type t ::
          ...
          | :SEAT_TYPE_ACTIVE_MEMBER
          | :SEAT_TYPE_NON_ACTIVE_MEMBER
          | :SEAT_TYPE_NON_MEMBER
...
defmodule InternalApi.Usage.ListDailyUsageRequest do
  ...
  @type t :: %__MODULE__{
          org_id: String.t(),
          period_started_at: Google.Protobuf.Timestamp.t() | nil,
          period_finished_at: Google.Protobuf.Timestamp.t() | nil
        }
...
defmodule InternalApi.Usage.ListSeatsRequest do
  ...
  @type t :: %__MODULE__{
          org_id: String.t(),
          from_gte: Google.Protobuf.Timestamp.t() | nil,
          to_lt: Google.Protobuf.Timestamp.t() | nil
        }
...
defmodule InternalApi.Usage.Seat do
  ...
  @type t :: %__MODULE__{
          ...
          origin: InternalApi.Usage.SeatOrigin.t(),
          status: InternalApi.Usage.SeatStatus.t(),
          date: Google.Protobuf.Timestamp.t() | nil
        }
...
defmodule InternalApi.Usage.OrganizationPolicyApply do
  ...
  @type t :: %__MODULE__{
          org_id: String.t(),
          cutoff_date: Google.Protobuf.Timestamp.t() | nil
        }
