...
defmodule Projecthub.HttpApi.Test do
  ...
  describe "PATCH /api/<version>/projects/:id with authorized user" do
    ...
    test "a task update that omits the notification flags leaves them unset for the server" do
      test_pid = self()
      ...
      assert task.skip_scheduled_run_notifications == nil
      assert task.skip_manual_run_notifications == nil
    end
