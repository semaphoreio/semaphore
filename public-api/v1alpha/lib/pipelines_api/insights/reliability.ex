defmodule PipelinesAPI.Insights.Reliability do
  @moduledoc "GET /projects/:project_id/insights/reliability"
  ...
  def show(conn, _opts) do
    Metrics.benchmark("PipelinesAPI.router", ["insights_reliability"], fn ->
      conn.params
