defmodule InternalClients.Dashboards do
  @moduledoc """
  ...
  @metrics_name "InternalClients.Dashboardhub"

  defdelegate form_request(args), to: InternalClients.Dashboards.RequestFormatter
  defdelegate send_request(request), to: InternalClients.Dashboards.GrpcClient
  defdelegate process_response(response), to: InternalClients.Dashboards.ResponseFormatter
