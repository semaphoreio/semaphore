defmodule PipelinesAPI.Insights.AuthorizeTest do
  use ExUnit.Case
  use Plug.Test

  alias PipelinesAPI.Insights.Authorize
  ...
  test "passes through when caller has project.view and project belongs to org" do
    ...
    conn =
      conn(:get, "/projects/#{project.id}/insights/performance")
  ...
  test "halts 404 when project belongs to a different org" do
    ...
    conn =
      conn(:get, "/projects/#{project_in_org1.id}/insights/performance")
