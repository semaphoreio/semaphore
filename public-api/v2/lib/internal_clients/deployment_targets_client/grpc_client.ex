defmodule InternalClients.DeploymentTargetsClient.GrpcClient do
  @moduledoc """
  ...
  alias API.DeploymentTargets.Stub
  require Logger

  @metrics_name "InternalClients.DeploymentTargets"
  ...
  defp endpoint_url, do: Application.get_env(:public_api, :gofer_grpc_endpoint)
  ...
  defp req_to_func(%API.HistoryRequest{}), do: &Stub.history/3
  defp req_to_func(%API.CordonRequest{}), do: &Stub.cordon/3
