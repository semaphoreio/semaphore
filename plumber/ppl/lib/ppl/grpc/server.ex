defmodule Ppl.Grpc.Server do
  ...
  defp verify_deployment_target_permission(%{source_args: nil}, _user_id), do: {:error, {:deployment_target_permission_denied, :missing_source_args}}
  defp verify_deployment_target_permission(%{source_args: %{"git_ref_type" => nil}}, _user_id), do: {:error, {:deployment_target_permission_denied, :missing_git_ref_type}}
  defp verify_deployment_target_permission(%{source_args: %{"git_ref_type" => other}}, _user_id), do: {:error, {:deployment_target_permission_denied, {:invalid_git_ref_type, other}}}
  defp verify_deployment_target_permission(%{source_args: %{}}, _user_id), do: {:error, {:deployment_target_permission_denied, :missing_git_ref_type}}
  defp verify_deployment_target_permission(%{request_args: %{"label" => ""}}, _user_id), do: {:error, {:deployment_target_permission_denied, :missing_label}}
  defp verify_deployment_target_permission(%{request_args: %{}}, _user_id), do: {:error, {:deployment_target_permission_denied, :missing_label}}
