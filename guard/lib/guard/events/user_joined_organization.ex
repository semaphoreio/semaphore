defmodule Guard.Events.UserJoinedOrganization do
  ...
  def publish(user_id, org_id, join_time \\ DateTime.utc_now()) do
    event =
      InternalApi.User.UserJoinedOrganization.new(
        user_id: user_id,
        org_id: org_id,
        timestamp: Google.Protobuf.Timestamp.new(seconds: join_time |> DateTime.to_unix(:second))
      )
