defmodule PublicAPI.Handlers.EventSources.List do
  @moduledoc false
  require Logger
  ...
  @operation_id "EventSources.List"
  ...
  @response_schema Schemas.EventSources.ListResponse
  ...
  plug(PublicAPI.Plugs.Metrics, tags: ["list", "event_sources"])
  plug(:list)
  ...
  def open_api_operation(_) do
    %Operation{
      tags: ["EventSources"],
      summary: "List canvas event sources",
      description: "List of event sources for the canvas.",
      ...
      parameters: [
        Operation.parameter(
          ...
          %Schema{
            anyOf: [
              PublicAPI.Schemas.Common.id("Canvas"),
  ...
  def list(conn, _opts) do
    ...
    |> case do
      ...
      err ->
        Logger.error("Error listing event sources: #{inspect(err)}")
