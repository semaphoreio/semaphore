defmodule InternalApi.User.Favorite.Kind do
  ...
  use Protobuf,
    enum: true,
    full_name: "InternalApi.User.Favorite.Kind",
...
defmodule InternalApi.User.DescribeResponse.RepoScope do
  ...
  use Protobuf,
    enum: true,
    full_name: "InternalApi.User.DescribeResponse.RepoScope",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.RepositoryProvider.Type do
  ...
  use Protobuf,
    enum: true,
    full_name: "InternalApi.User.RepositoryProvider.Type",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.RepositoryProvider.Scope do
  ...
  use Protobuf,
    enum: true,
    full_name: "InternalApi.User.RepositoryProvider.Scope",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.RepositoryScopes.RepositoryScope.Scope do
  ...
  use Protobuf,
    enum: true,
    full_name: "InternalApi.User.RepositoryScopes.RepositoryScope.Scope",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.User.CreationSource do
  ...
  use Protobuf,
    enum: true,
    full_name: "InternalApi.User.User.CreationSource",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.ListFavoritesRequest do
  ...
  use Protobuf,
    full_name: "InternalApi.User.ListFavoritesRequest",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.ListFavoritesResponse do
  ...
  use Protobuf,
    full_name: "InternalApi.User.ListFavoritesResponse",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.Favorite do
  ...
  use Protobuf,
    full_name: "InternalApi.User.Favorite",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.DescribeManyRequest do
  ...
  use Protobuf,
    full_name: "InternalApi.User.DescribeManyRequest",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.DescribeManyResponse do
  ...
  use Protobuf,
    full_name: "InternalApi.User.DescribeManyResponse",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.DescribeRequest do
  ...
  use Protobuf,
    full_name: "InternalApi.User.DescribeRequest",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.DescribeResponse do
  ...
  use Protobuf,
    full_name: "InternalApi.User.DescribeResponse",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.RepositoryProvider do
  ...
  use Protobuf,
    full_name: "InternalApi.User.RepositoryProvider",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.RepositoryScopes.RepositoryScope do
  ...
  use Protobuf,
    full_name: "InternalApi.User.RepositoryScopes.RepositoryScope",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.RepositoryScopes do
  ...
  use Protobuf,
    full_name: "InternalApi.User.RepositoryScopes",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.UpdateRequest do
  ...
  use Protobuf,
    full_name: "InternalApi.User.UpdateRequest",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.UpdateResponse do
  ...
  use Protobuf,
    full_name: "InternalApi.User.UpdateResponse",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.SearchUsersRequest do
  ...
  use Protobuf,
    full_name: "InternalApi.User.SearchUsersRequest",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.SearchUsersResponse do
  ...
  use Protobuf,
    full_name: "InternalApi.User.SearchUsersResponse",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.DeleteWithOwnedOrgsRequest do
  ...
  use Protobuf,
    full_name: "InternalApi.User.DeleteWithOwnedOrgsRequest",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.RegenerateTokenRequest do
  ...
  use Protobuf,
    full_name: "InternalApi.User.RegenerateTokenRequest",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.RegenerateTokenResponse do
  ...
  use Protobuf,
    full_name: "InternalApi.User.RegenerateTokenResponse",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.CheckGithubTokenRequest do
  ...
  use Protobuf,
    full_name: "InternalApi.User.CheckGithubTokenRequest",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.CheckGithubTokenResponse do
  ...
  use Protobuf,
    full_name: "InternalApi.User.CheckGithubTokenResponse",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.BlockAccountRequest do
  ...
  use Protobuf,
    full_name: "InternalApi.User.BlockAccountRequest",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.UnblockAccountRequest do
  ...
  use Protobuf,
    full_name: "InternalApi.User.UnblockAccountRequest",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.GetRepositoryTokenRequest do
  ...
  use Protobuf,
    full_name: "InternalApi.User.GetRepositoryTokenRequest",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.GetRepositoryTokenResponse do
  ...
  use Protobuf,
    full_name: "InternalApi.User.GetRepositoryTokenResponse",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.DescribeByRepositoryProviderRequest do
  ...
  use Protobuf,
    full_name: "InternalApi.User.DescribeByRepositoryProviderRequest",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.DescribeByEmailRequest do
  ...
  use Protobuf,
    full_name: "InternalApi.User.DescribeByEmailRequest",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.RefreshRepositoryProviderRequest do
  ...
  use Protobuf,
    full_name: "InternalApi.User.RefreshRepositoryProviderRequest",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.RefreshRepositoryProviderResponse do
  ...
  use Protobuf,
    full_name: "InternalApi.User.RefreshRepositoryProviderResponse",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.CreateRequest do
  ...
  use Protobuf,
    full_name: "InternalApi.User.CreateRequest",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.User do
  ...
  use Protobuf,
    full_name: "InternalApi.User.User",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.UserCreated do
  ...
  use Protobuf,
    full_name: "InternalApi.User.UserCreated",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.UserDeleted do
  ...
  use Protobuf,
    full_name: "InternalApi.User.UserDeleted",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.UserUpdated do
  ...
  use Protobuf,
    full_name: "InternalApi.User.UserUpdated",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.UserJoinedOrganization do
  ...
  use Protobuf,
    full_name: "InternalApi.User.UserJoinedOrganization",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.UserLeftOrganization do
  ...
  use Protobuf,
    full_name: "InternalApi.User.UserLeftOrganization",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.MemberInvited do
  ...
  use Protobuf,
    full_name: "InternalApi.User.MemberInvited",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.ActiveOwner do
  ...
  use Protobuf,
    full_name: "InternalApi.User.ActiveOwner",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.InactiveOwner do
  ...
  use Protobuf,
    full_name: "InternalApi.User.InactiveOwner",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.WorkEmailAdded do
  ...
  use Protobuf,
    full_name: "InternalApi.User.WorkEmailAdded",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.FavoriteCreated do
  ...
  use Protobuf,
    full_name: "InternalApi.User.FavoriteCreated",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.FavoriteDeleted do
  ...
  use Protobuf,
    full_name: "InternalApi.User.FavoriteDeleted",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule InternalApi.User.UserService.Service do
  ...
  use GRPC.Service, name: "InternalApi.User.UserService", protoc_gen_elixir_version: "0.17.0"
