...
This page explains how Semaphore's MCP Server works, how to configure your clients/agents, and what tools are available.
...
Semaphore's MCP Server provides read-only access to the following parts of your organization:
...
Access to the MCP Server is controlled via an API Token?
