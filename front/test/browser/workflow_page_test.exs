defmodule Front.Browser.WorkflowPage do
  ...
  describe "header" do
    browser_test "the users can see information about the commit", params do
      page = open(params)
  ...
  describe "diagram" do
    browser_test "the users can see the pipeline", params do
      page = open(params)
    ...
    browser_test "the users can see promotions", params do
      page = open(params)
    ...
    browser_test "promotions with unicode characters (emoji) are displayed correctly", params do
    ...
    browser_test "promotions with accented characters are displayed correctly", params do
      switch = params.switch
    ...
    browser_test "promotions with CJK characters are displayed correctly", params do
      switch = params.switch
    ...
    browser_test "promotions with single quotes are displayed and clickable", params do
      switch = params.switch
    ...
    browser_test "promotions with mixed unicode and special characters work correctly", params do
      switch = params.switch
    ...
    browser_test "If project is public, show blocks, but promotions should be disabled", params do
  ...
  describe "editing a workflow" do
    browser_test "edit button is visible when user has write github access", params do
      open(params) |> assert_has(@edit_link)
    end

    browser_test "click on 'edit' opens the Visual Builder", params do
  ...
  describe "waiting time" do
    ...
    browser_test "when the waiting is > 20 secs => display link to Activity Monitor", params do
    ...
    browser_test "when the waiting is < 20 secs => don't display Activity link", params do
