defmodule InternalClients.Dashboards.GrpcClient do
  @moduledoc """
  ...
  alias API.DashboardsService.Stub
  require Logger
  ...
  def send_request({:ok, request}) do
    ...
    case maybe_result do
      ...
      {:error, reason} ->
        Log.internal_error(reason, "Could not forward the request", "Dashboards")
    end
  end
  ...
  defp endpoint_url, do: Application.get_env(:public_api, :dashboardhub_grpc_endpoint)
