defmodule FrontWeb.ProjectControllerTest do
  ...
  describe "GET check_commit_job" do
    test "returns commit_sha read from artifacts if the job has passed",
      ...
      params = [
        path: ".workflow_editor/commit_sha.txt",
        scope: "jobs",
        url: "https://localhost:9000/commit_sha.txt"
      ]
    ...
    defp mocked_get_file(url) do
      if url == "https://localhost:9000/commit_sha.txt" do
  ...
  defp expected_spec do
    %InternalApi.ServerFarm.Job.JobSpec{
      ...
      commands: [
        ...
        "export GIT_REPO_URL=\"${SEMAPHORE_GIT_URL/git@/https://$GIT_USERNAME:$GIT_PASSWORD@}\"",
        ...
        "git rev-parse HEAD > ../.workflow_editor/commit_sha.txt",
        "artifacts push job ../.workflow_editor/commit_sha.txt"
      ],
