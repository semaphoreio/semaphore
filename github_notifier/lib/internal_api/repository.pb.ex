defmodule InternalApi.Repository.Collaborator.Permission do
  ...
  @type t :: integer | :ADMIN | :WRITE | :READ
...
defmodule InternalApi.Repository.CreateBuildStatusRequest.Status do
  @moduledoc false
  use Protobuf, enum: true, syntax: :proto3
  @type t :: integer | :SUCCESS | :PENDING | :FAILURE | :STOPPED
...
defmodule InternalApi.Repository.GetChangedFilePathsRequest.ComparisonType do
  @moduledoc false
  use Protobuf, enum: true, syntax: :proto3
  @type t :: integer | :HEAD_TO_MERGE_BASE | :HEAD_TO_HEAD
...
defmodule InternalApi.Repository.CommitRequest.Change.Action do
  @moduledoc false
  use Protobuf, enum: true, syntax: :proto3
  @type t :: integer | :ADD_FILE | :MODIFY_FILE | :DELETE_FILE
...
defmodule InternalApi.Repository.DescribeRevisionRequest do
  ...
  @type t :: %__MODULE__{
          ...
          revision: InternalApi.Repository.Revision.t() | nil
        }
...
defmodule InternalApi.Repository.DescribeRevisionResponse do
  ...
  @type t :: %__MODULE__{
          commit: InternalApi.Repository.Commit.t() | nil
        }
...
defmodule InternalApi.Repository.DescribeRemoteRepositoryResponse do
  ...
  @type t :: %__MODULE__{
          remote_repository: InternalApi.Repository.RemoteRepository.t() | nil
        }
...
defmodule InternalApi.Repository.CheckDeployKeyResponse do
  ...
  @type t :: %__MODULE__{
          deploy_key: InternalApi.Repository.DeployKey.t() | nil
        }
...
defmodule InternalApi.Repository.CheckWebhookResponse do
  ...
  @type t :: %__MODULE__{
          webhook: InternalApi.Repository.Webhook.t() | nil
        }
...
defmodule InternalApi.Repository.Collaborator do
  ...
  @type t :: %__MODULE__{
          id: String.t(),
          login: String.t(),
          permission: InternalApi.Repository.Collaborator.Permission.t()
        }
...
defmodule InternalApi.Repository.CreateBuildStatusRequest do
  ...
  @type t :: %__MODULE__{
          repository_id: String.t(),
          commit_sha: String.t(),
          status: InternalApi.Repository.CreateBuildStatusRequest.Status.t(),
          url: String.t(),
...
defmodule InternalApi.Repository.CreateBuildStatusResponse do
  ...
  @type t :: %__MODULE__{
          code: InternalApi.Repository.CreateBuildStatusResponse.Code.t()
        }
...
defmodule InternalApi.Repository.DescribeResponse do
  ...
  @type t :: %__MODULE__{
          repository: InternalApi.Repository.Repository.t() | nil,
...
defmodule InternalApi.Repository.Repository do
  ...
  @type t :: %__MODULE__{
          ...
          integration_type: InternalApi.RepositoryIntegrator.IntegrationType.t(),
          commit_status: InternalApi.Projecthub.Project.Spec.Repository.Status.t() | nil,
...
defmodule InternalApi.Repository.GetFileResponse do
  ...
  @type t :: %__MODULE__{
          file: InternalApi.Repository.File.t() | nil
        }
...
defmodule InternalApi.Repository.GetChangedFilePathsRequest do
  ...
  @type t :: %__MODULE__{
          head_rev: InternalApi.Repository.Revision.t() | nil,
          base_rev: InternalApi.Repository.Revision.t() | nil,
          repository_id: String.t(),
          comparison_type: InternalApi.Repository.GetChangedFilePathsRequest.ComparisonType.t()
        }
...
defmodule InternalApi.Repository.CommitRequest.Change do
  ...
  @type t :: %__MODULE__{
          action: InternalApi.Repository.CommitRequest.Change.Action.t(),
          file: InternalApi.Repository.File.t() | nil
        }
