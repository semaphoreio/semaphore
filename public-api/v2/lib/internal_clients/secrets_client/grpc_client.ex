defmodule InternalClients.Secrets.GrpcClient do
  @moduledoc """
  ...
  defp endpoint_url, do: Application.get_env(:public_api, :secrethub_grpc_endpoint)
  ...
  defp req_to_func(%API.GetKeyRequest{}), do: &Stub.get_key/3
