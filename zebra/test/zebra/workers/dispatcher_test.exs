defmodule Zebra.Workers.DispatcherTest do
  ...
  describe ".tick" do
    ...
    test "isolates dispatching by both machine_type and os_image" do
      ...
      assert length(requested_os_images) == 9
      assert Enum.count(requested_os_images, &(&1 == "ubuntu1804")) == 3
      assert Enum.count(requested_os_images, &(&1 == "ubuntu2004")) == 3
      assert Enum.count(requested_os_images, &(&1 == "ubuntu2404")) == 3
    end
  end
