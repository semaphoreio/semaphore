...
defmodule Semaphore.Notifications.V1alpha.Notification.Spec.Rule.Notify.Slack do
  ...
  @type t :: %__MODULE__{
          ...
          channels: [String.t()],
          message: String.t(),
          status: Semaphore.Notifications.V1alpha.Notification.Spec.Rule.Notify.Status.t()
        }
...
defmodule Semaphore.Notifications.V1alpha.Notification.Spec.Rule.Notify do
  ...
  @type t :: %__MODULE__{
          slack: Semaphore.Notifications.V1alpha.Notification.Spec.Rule.Notify.Slack.t() | nil,
          email: Semaphore.Notifications.V1alpha.Notification.Spec.Rule.Notify.Email.t() | nil,
          webhook: Semaphore.Notifications.V1alpha.Notification.Spec.Rule.Notify.Webhook.t() | nil
        }
...
defmodule Semaphore.Notifications.V1alpha.Notification.Spec.Rule do
  ...
  @type t :: %__MODULE__{
          name: String.t(),
          filter: Semaphore.Notifications.V1alpha.Notification.Spec.Rule.Filter.t() | nil,
          notify: Semaphore.Notifications.V1alpha.Notification.Spec.Rule.Notify.t() | nil
        }
...
defmodule Semaphore.Notifications.V1alpha.Notification do
  ...
  @type t :: %__MODULE__{
          metadata: Semaphore.Notifications.V1alpha.Notification.Metadata.t() | nil,
          spec: Semaphore.Notifications.V1alpha.Notification.Spec.t() | nil,
          status: Semaphore.Notifications.V1alpha.Notification.Status.t() | nil
        }
...
defmodule Semaphore.Notifications.V1alpha.ListNotificationsRequest do
  ...
  @type t :: %__MODULE__{
          page_size: integer,
          page_token: String.t(),
          order: Semaphore.Notifications.V1alpha.ListNotificationsRequest.Order.t()
        }
...
defmodule Semaphore.Notifications.V1alpha.UpdateNotificationRequest do
  ...
  @type t :: %__MODULE__{
          notification_id_or_name: String.t(),
          notification: Semaphore.Notifications.V1alpha.Notification.t() | nil
        }
