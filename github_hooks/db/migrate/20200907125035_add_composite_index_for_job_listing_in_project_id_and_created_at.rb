class AddCompositeIndexForJobListingInProjectIdAndCreatedAt < ActiveRecord::Migration[5.1]
  ...
  # given organization.
  #
  # The query uses the combination of project_ids and job state to list jobs, and
  # finally orders them by created_at.
  #
  # What we have now:
  #
  #   Currently we have an index for project_id, and created_at on jobs.
  ...
  #      project_id. This is slow if you haven't executed any job for over a
  #      day.
  #
  #   2. Or, it uses the project_id index. In this case it needs to
  ...
  #
  #     1. Compositing the index on project_id, created_at, and aasm_state.
  #
