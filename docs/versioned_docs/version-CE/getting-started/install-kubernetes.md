...
This page explains how to install the Semaphore Community Edition control plane on Kubernetes cluster.
...
## Step 2 - Prepare the environment {#env}

<Tabs groupId="platform">
  <TabItem value="gke" label="Google Kubernetes Engine">

This section creates [Google Cloud Kubernetes Engine (GKE)](https://cloud.google.com/kubernetes-engine) and prepares it for Semaphore Community Edition.
