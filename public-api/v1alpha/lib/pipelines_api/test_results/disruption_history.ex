defmodule PipelinesAPI.TestResults.DisruptionHistory do
  @moduledoc "GET /projects/:project_id/test_results/disruption_history"
  ...
  def history(conn, _opts) do
    Metrics.benchmark("PipelinesAPI.router", ["test_results_disruption_history"], fn ->
      org_id = get_org_id(conn)

      conn.params
      |> Map.put("org_id", org_id)
      |> SuperjerryClient.list_disruption_history()
