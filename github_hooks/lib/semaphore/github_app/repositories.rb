module Semaphore::GithubApp
  class Repositories
    ...
    # sync_collaborators gates only the per-repo collaborator workers; the
    # repository list is always reconciled. Lets a caller refresh the repo list
    # without the collaborator fan-out (e.g. webhook sync when collaborator sync
    # is disabled via env).
