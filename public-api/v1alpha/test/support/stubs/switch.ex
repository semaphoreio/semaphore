  ...
  defmodule Grpc do
    ...
    def trigger(req, _) do
      case find_target(req.switch_id, req.target_name) do
        nil ->
          InternalApi.Gofer.TriggerResponse.new(response_status: status_not_found())

        target ->
          Support.Stubs.Switch.add_trigger_event(target)
          InternalApi.Gofer.TriggerResponse.new(response_status: status_ok())
      end
    end
    ...
    def list_trigger_events(req, _) do
      ...
      InternalApi.Gofer.ListTriggerEventsResponse.new(
