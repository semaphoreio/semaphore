defmodule Zebra.Workers.JobRequestFactory.Secrets do
  ...
  def load(org_id, job_id, spec, project, repo_proxy, job_type \\ :pipeline_job) do
    Watchman.benchmark("zebra.external.secrethub.checkout_many", fn ->
      ...
      names =
        ...
        |> filter_names(project, repo_proxy, job_type)
  ...
  defp filter_names(names, _, nil, _job_type), do: names

  defp filter_names(names, project, repo_proxy, job_type) do
    if should_filter_forked_pr_secrets?(repo_proxy, job_type) do
