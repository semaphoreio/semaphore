  ...
  describe "#create_blank" do
    ...
    context "when unknown error occurs" do
      ...
      it "logs and raises GRPC::Internal" do
        expect(call).to receive(:error).with("Unknown error", error: "Boom")
    ...
    context "when the user is not found" do
      before do
        allow(::User).to receive(:find).and_raise(
          ::ActiveRecord::RecordNotFound.new("Not Found", model: ::User)
        )
      end
    ...
    context "when the project is not found" do
      before do
        allow(::Project).to receive(:find).and_raise(
          ::ActiveRecord::RecordNotFound.new("Not Found", model: ::Project)
        )
      end
