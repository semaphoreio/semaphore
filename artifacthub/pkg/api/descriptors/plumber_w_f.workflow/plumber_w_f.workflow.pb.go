...
import (
	...
	status "github.com/semaphoreio/semaphore/artifacthub/pkg/api/descriptors/include/internal_api/status"
...
func (*WorkflowDeleted) Descriptor() ([]byte, []int) {
	return file_plumber_w_f_workflow_proto_rawDescGZIP(), []int{28}
}
...
func (x *GetPathResponse_PathElement) Reset() {
	*x = GetPathResponse_PathElement{}
	mi := &file_plumber_w_f_workflow_proto_msgTypes[31]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_plumber_w_f_workflow_proto_rawDesc = "" +
	...
	"\x06Create\x12$.InternalApi.PlumberWF.CreateRequest\x1a%.InternalApi.PlumberWF.CreateResponseBWZUgithub.com/semaphoreio/semaphore/artifacthub/pkg/api/descriptors/plumber_w_f.workflowb\x06proto3"
...
var file_plumber_w_f_workflow_proto_msgTypes = make([]protoimpl.MessageInfo, 32)
var file_plumber_w_f_workflow_proto_goTypes = []any{
	...
	(*WorkflowDeleted)(nil),                   // 38: InternalApi.PlumberWF.WorkflowDeleted
	(*ScheduleRequest_Repo)(nil),              // 39: InternalApi.PlumberWF.ScheduleRequest.Repo
	(*ScheduleRequest_EnvVar)(nil),            // 40: InternalApi.PlumberWF.ScheduleRequest.EnvVar
	(*GetPathResponse_PathElement)(nil),       // 41: InternalApi.PlumberWF.GetPathResponse.PathElement
	(*status.Status)(nil),                     // 42: InternalApi.Status
...
var file_plumber_w_f_workflow_proto_depIdxs = []int32{
	...
	39, // 1: InternalApi.PlumberWF.ScheduleRequest.repo:type_name -> InternalApi.PlumberWF.ScheduleRequest.Repo
	0,  // 2: InternalApi.PlumberWF.ScheduleRequest.triggered_by:type_name -> InternalApi.PlumberWF.TriggeredBy
	40, // 3: InternalApi.PlumberWF.ScheduleRequest.env_vars:type_name -> InternalApi.PlumberWF.ScheduleRequest.EnvVar
	42, // 4: InternalApi.PlumberWF.ScheduleResponse.status:type_name -> InternalApi.Status
	43, // 5: InternalApi.PlumberWF.GetPathResponse.wf_created_at:type_name -> google.protobuf.Timestamp
	41, // 6: InternalApi.PlumberWF.GetPathResponse.path:type_name -> InternalApi.PlumberWF.GetPathResponse.PathElement
	42, // 7: InternalApi.PlumberWF.GetPathResponse.status:type_name -> InternalApi.Status
	...
	42, // 18: InternalApi.PlumberWF.ListGroupedResponse.status:type_name -> InternalApi.Status
	24, // 19: InternalApi.PlumberWF.ListGroupedResponse.workflows:type_name -> InternalApi.PlumberWF.WorkflowDetails
	43, // 20: InternalApi.PlumberWF.ListRequest.created_before:type_name -> google.protobuf.Timestamp
	43, // 21: InternalApi.PlumberWF.ListRequest.created_after:type_name -> google.protobuf.Timestamp
	1,  // 22: InternalApi.PlumberWF.ListRequest.git_ref_types:type_name -> InternalApi.PlumberWF.GitRefType
	42, // 23: InternalApi.PlumberWF.ListResponse.status:type_name -> InternalApi.Status
	...
	43, // 26: InternalApi.PlumberWF.ListKeysetRequest.created_before:type_name -> google.protobuf.Timestamp
	43, // 27: InternalApi.PlumberWF.ListKeysetRequest.created_after:type_name -> google.protobuf.Timestamp
	...
	42, // 31: InternalApi.PlumberWF.ListKeysetResponse.status:type_name -> InternalApi.Status
	24, // 32: InternalApi.PlumberWF.ListKeysetResponse.workflows:type_name -> InternalApi.PlumberWF.WorkflowDetails
	43, // 33: InternalApi.PlumberWF.WorkflowDetails.created_at:type_name -> google.protobuf.Timestamp
	0,  // 34: InternalApi.PlumberWF.WorkflowDetails.triggered_by:type_name -> InternalApi.PlumberWF.TriggeredBy
	42, // 35: InternalApi.PlumberWF.DescribeResponse.status:type_name -> InternalApi.Status
	24, // 36: InternalApi.PlumberWF.DescribeResponse.workflow:type_name -> InternalApi.PlumberWF.WorkflowDetails
	42, // 37: InternalApi.PlumberWF.DescribeManyResponse.status:type_name -> InternalApi.Status
	24, // 38: InternalApi.PlumberWF.DescribeManyResponse.workflows:type_name -> InternalApi.PlumberWF.WorkflowDetails
	42, // 39: InternalApi.PlumberWF.TerminateResponse.status:type_name -> InternalApi.Status
	42, // 40: InternalApi.PlumberWF.ListLabelsResponse.status:type_name -> InternalApi.Status
	42, // 41: InternalApi.PlumberWF.GetProjectIdResponse.status:type_name -> InternalApi.Status
	42, // 42: InternalApi.PlumberWF.CreateResponse.status:type_name -> InternalApi.Status
	43, // 43: InternalApi.PlumberWF.WorkflowDeleted.deleted_at:type_name -> google.protobuf.Timestamp
	10, // 44: InternalApi.PlumberWF.WorkflowService.Schedule:input_type -> InternalApi.PlumberWF.ScheduleRequest
	12, // 45: InternalApi.PlumberWF.WorkflowService.GetPath:input_type -> InternalApi.PlumberWF.GetPathRequest
	20, // 46: InternalApi.PlumberWF.WorkflowService.List:input_type -> InternalApi.PlumberWF.ListRequest
	22, // 47: InternalApi.PlumberWF.WorkflowService.ListKeyset:input_type -> InternalApi.PlumberWF.ListKeysetRequest
	18, // 48: InternalApi.PlumberWF.WorkflowService.ListGrouped:input_type -> InternalApi.PlumberWF.ListGroupedRequest
	16, // 49: InternalApi.PlumberWF.WorkflowService.ListGroupedKS:input_type -> InternalApi.PlumberWF.ListGroupedKSRequest
	14, // 50: InternalApi.PlumberWF.WorkflowService.ListLatestWorkflows:input_type -> InternalApi.PlumberWF.ListLatestWorkflowsRequest
	25, // 51: InternalApi.PlumberWF.WorkflowService.Describe:input_type -> InternalApi.PlumberWF.DescribeRequest
	27, // 52: InternalApi.PlumberWF.WorkflowService.DescribeMany:input_type -> InternalApi.PlumberWF.DescribeManyRequest
	29, // 53: InternalApi.PlumberWF.WorkflowService.Terminate:input_type -> InternalApi.PlumberWF.TerminateRequest
	31, // 54: InternalApi.PlumberWF.WorkflowService.ListLabels:input_type -> InternalApi.PlumberWF.ListLabelsRequest
	33, // 55: InternalApi.PlumberWF.WorkflowService.Reschedule:input_type -> InternalApi.PlumberWF.RescheduleRequest
	34, // 56: InternalApi.PlumberWF.WorkflowService.GetProjectId:input_type -> InternalApi.PlumberWF.GetProjectIdRequest
	36, // 57: InternalApi.PlumberWF.WorkflowService.Create:input_type -> InternalApi.PlumberWF.CreateRequest
	11, // 58: InternalApi.PlumberWF.WorkflowService.Schedule:output_type -> InternalApi.PlumberWF.ScheduleResponse
	13, // 59: InternalApi.PlumberWF.WorkflowService.GetPath:output_type -> InternalApi.PlumberWF.GetPathResponse
	21, // 60: InternalApi.PlumberWF.WorkflowService.List:output_type -> InternalApi.PlumberWF.ListResponse
	23, // 61: InternalApi.PlumberWF.WorkflowService.ListKeyset:output_type -> InternalApi.PlumberWF.ListKeysetResponse
	19, // 62: InternalApi.PlumberWF.WorkflowService.ListGrouped:output_type -> InternalApi.PlumberWF.ListGroupedResponse
	17, // 63: InternalApi.PlumberWF.WorkflowService.ListGroupedKS:output_type -> InternalApi.PlumberWF.ListGroupedKSResponse
	15, // 64: InternalApi.PlumberWF.WorkflowService.ListLatestWorkflows:output_type -> InternalApi.PlumberWF.ListLatestWorkflowsResponse
	26, // 65: InternalApi.PlumberWF.WorkflowService.Describe:output_type -> InternalApi.PlumberWF.DescribeResponse
	28, // 66: InternalApi.PlumberWF.WorkflowService.DescribeMany:output_type -> InternalApi.PlumberWF.DescribeManyResponse
	30, // 67: InternalApi.PlumberWF.WorkflowService.Terminate:output_type -> InternalApi.PlumberWF.TerminateResponse
	32, // 68: InternalApi.PlumberWF.WorkflowService.ListLabels:output_type -> InternalApi.PlumberWF.ListLabelsResponse
	11, // 69: InternalApi.PlumberWF.WorkflowService.Reschedule:output_type -> InternalApi.PlumberWF.ScheduleResponse
	35, // 70: InternalApi.PlumberWF.WorkflowService.GetProjectId:output_type -> InternalApi.PlumberWF.GetProjectIdResponse
	37, // 71: InternalApi.PlumberWF.WorkflowService.Create:output_type -> InternalApi.PlumberWF.CreateResponse
