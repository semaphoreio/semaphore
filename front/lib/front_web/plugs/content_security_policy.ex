  ...
  defp options do
    ...
    [
      ...
      directives: %{
        ...
        img_src:
          ~w(data: 'self' *.userpilot.io static.zdassets.com *.zendesk.com gravatar.com githubusercontent.com *.githubusercontent.com *.gravatar.com *.wp.com *.githubusercontent.com d12wqas9hcki3z.cloudfront.net bitbucket.org github.com gitlab.com beacon-v2.helpscout.net d33v4339jhl8k0.cloudfront.net chatapi-prod.s3.amazonaws.com/ bitbucket-assetroot.s3.amazonaws.com ui-avatars.com *.atl-paas.net *.sitesearch360.com) ++
            ["docs.#{base_domain}"],
        script_src:
