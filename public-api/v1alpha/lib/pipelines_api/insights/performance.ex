defmodule PipelinesAPI.Insights.Performance do
  @moduledoc "GET /projects/:project_id/insights/performance"
  ...
  def show(conn, _opts) do
    Metrics.benchmark("PipelinesAPI.router", ["insights_performance"], fn ->
      conn.params
