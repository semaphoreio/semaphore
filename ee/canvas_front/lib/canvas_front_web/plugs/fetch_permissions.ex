defmodule CanvasFrontWeb.Plugs.FetchPermissions do
  @moduledoc """
  ...
  def call(conn, opts) do
    ...
    conn
    |> fetch_permissions_for_controller(opts[:scope])
  end

  defp fetch_permissions_for_controller(conn, scope), do: assign_permissions(conn, scope)
