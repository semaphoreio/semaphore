defmodule PipelinesAPI.ServiceAccountClient.GrpcClient do
  ...
  def create({:ok, request}) do
    result = Wormhole.capture(__MODULE__, :create_, [request], stacktrace: true, skip_log: true, timeout_ms: @wormhole_timeout)
  ...
  def list({:ok, request}) do
    result = Wormhole.capture(__MODULE__, :list_, [request], stacktrace: true, skip_log: true, timeout_ms: @wormhole_timeout)
  ...
  def describe({:ok, request}) do
    result = Wormhole.capture(__MODULE__, :describe_, [request], stacktrace: true, skip_log: true, timeout_ms: @wormhole_timeout)
  ...
  def update({:ok, request}) do
    result = Wormhole.capture(__MODULE__, :update_, [request], stacktrace: true, skip_log: true, timeout_ms: @wormhole_timeout)
  ...
  def destroy({:ok, request}) do
    result = Wormhole.capture(__MODULE__, :destroy_, [request], stacktrace: true, skip_log: true, timeout_ms: @wormhole_timeout)
  ...
  def deactivate({:ok, request}) do
    result =
      Wormhole.capture(__MODULE__, :deactivate_, [request], stacktrace: true, skip_log: true, timeout_ms: @wormhole_timeout)
  ...
  def reactivate({:ok, request}) do
    result =
      Wormhole.capture(__MODULE__, :reactivate_, [request], stacktrace: true, skip_log: true, timeout_ms: @wormhole_timeout)
  ...
  def regenerate_token_(request) do
    ...
    Metrics.benchmark("PipelinesAPI.service_account_client.grpc_client", ["regenerate_token"], fn ->
      channel
