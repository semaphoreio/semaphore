defmodule PipelinesAPI.TestResults.Authorize do
  @moduledoc "Authorization plug for test_results endpoints: project.view + cross-org gate."
  ...
  def authorize_read(conn, _opts) do
    ...
    with :ok <- Auth.project_belongs_to_org(org_id, project_id),
      ...
      {:error, {:internal, _}} = error ->
        LT.error(error, "TestResults.Authorize")
