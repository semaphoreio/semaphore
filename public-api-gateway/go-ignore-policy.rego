...
ignore {
	deny_vulnerability_ids := {
		...
		# Availability-only DoS, but this gateway terminates external traffic — the x/net bump
		# should be prioritized as the real fix; this ignore is a temporary CI unblock.
		"CVE-2026-33814",
		...
		# rapid-reset variant is availability-only.
		"GHSA-hrxh-6v49-42gf"
	}
