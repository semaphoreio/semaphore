defmodule PipelinesAPI.TestResults.ListFlakyTests do
  @moduledoc "GET /projects/:project_id/test_results/flaky_tests"
  ...
  def list(conn, _opts) do
    Metrics.benchmark("PipelinesAPI.router", ["test_results_list_flaky_tests"], fn ->
