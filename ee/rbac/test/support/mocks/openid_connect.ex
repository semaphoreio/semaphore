defmodule Rbac.Mocks.OpenIDConnect do
  def stub_oidc_connection do
    ...
    bypass = Rbac.Mocks.OpenIDConnect.discovery_document_server()
    ...
    {token, _claims} =
      Rbac.Mocks.OpenIDConnect.generate_openid_connect_token(%{client_id: "test_client_id"}, %{
        id: Ecto.UUID.generate(),
        name: "test",
        email: "email@email.com"
      })

    Rbac.Mocks.OpenIDConnect.expect_fetch_token(bypass, %{
      "token_type" => "Bearer",
      "id_token" => token,
