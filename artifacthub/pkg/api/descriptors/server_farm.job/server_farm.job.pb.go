...
import (
	...
	response_status "github.com/semaphoreio/semaphore/artifacthub/pkg/api/descriptors/include/internal_api/response_status"
...
func (x *JobDeleted) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*JobDeleted) ProtoMessage() {}

func (x *JobDeleted) ProtoReflect() protoreflect.Message {
	mi := &file_server_farm_job_proto_msgTypes[25]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use JobDeleted.ProtoReflect.Descriptor instead.
func (*JobDeleted) Descriptor() ([]byte, []int) {
	return file_server_farm_job_proto_rawDescGZIP(), []int{25}
}

func (x *JobDeleted) GetJobId() string {
	if x != nil {
		return x.JobId
	}
	return ""
...
func (x *JobDeleted) GetOrganizationId() string {
	if x != nil {
		return x.OrganizationId
	}
	return ""
...
func (x *JobDeleted) GetDeletedAt() *timestamp.Timestamp {
	if x != nil {
		return x.DeletedAt
	}
	return nil
...
func (x *JobDeleted) GetArtifactStoreId() string {
	if x != nil {
...
func (x *JobDeleted) GetProjectId() string {
	if x != nil {
		return x.ProjectId
	}
	return ""
...
func (x *JobSpec_Agent_ImagePullSecret) Reset() {
	*x = JobSpec_Agent_ImagePullSecret{}
	mi := &file_server_farm_job_proto_msgTypes[34]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_server_farm_job_proto_rawDesc = "" +
	"\n" +
	...
	"\x06job_id\x18\x01 \x01(\tR\x05jobId\"\xd1\v\n" +
	"\x03Job\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1d\n" +
	"\n" +
	"project_id\x18\x02 \x01(\tR\tprojectId\x12\x1b\n" +
	"\tbranch_id\x18\x03 \x01(\tR\bbranchId\x12\x17\n" +
	"\ahook_id\x18\x04 \x01(\tR\x06hookId\x12D\n" +
	"\btimeline\x18\x05 \x01(\v2(.InternalApi.ServerFarm.Job.Job.TimelineR\btimeline\x12;\n" +
	"\x05state\x18\x06 \x01(\x0e2%.InternalApi.ServerFarm.Job.Job.StateR\x05state\x12>\n" +
	"\x06result\x18\a \x01(\x0e2&.InternalApi.ServerFarm.Job.Job.ResultR\x06result\x12&\n" +
	"\x0fbuild_server_ip\x18\b \x01(\tR\rbuildServerIp\x12\x15\n" +
	"\x06ppl_id\x18\t \x01(\tR\x05pplId\x12\x12\n" +
	"\x04name\x18\n" +
	" \x01(\tR\x04name\x12\x14\n" +
	"\x05index\x18\v \x01(\x05R\x05index\x12%\n" +
	"\x0efailure_reason\x18\f \x01(\tR\rfailureReason\x12!\n" +
	"\fmachine_type\x18\r \x01(\tR\vmachineType\x12(\n" +
	"\x10machine_os_image\x18\x0e \x01(\tR\x0emachineOsImage\x12\x1d\n" +
	"\n" +
	"agent_host\x18\x0f \x01(\tR\tagentHost\x12&\n" +
	"\x0fagent_ctrl_port\x18\x10 \x01(\x05R\ragentCtrlPort\x12$\n" +
	"\x0eagent_ssh_port\x18\x11 \x01(\x05R\fagentSshPort\x12(\n" +
	"\x10agent_auth_token\x18\x12 \x01(\tR\x0eagentAuthToken\x12\x1a\n" +
	"\bpriority\x18\x13 \x01(\x05R\bpriority\x12 \n" +
	"\fis_debug_job\x18\x14 \x01(\bR\n" +
	"isDebugJob\x12\"\n" +
	"\rdebug_user_id\x18\x15 \x01(\tR\vdebugUserId\x12\x1f\n" +
	"\vself_hosted\x18\x16 \x01(\bR\n" +
	"selfHosted\x12'\n" +
	"\x0forganization_id\x18\x17 \x01(\tR\x0eorganizationId\x12 \n" +
	"\fbuild_req_id\x18\x18 \x01(\tR\n" +
	"buildReqId\x12\x1d\n" +
	"\n" +
	"agent_name\x18\x19 \x01(\tR\tagentName\x12\x19\n" +
	"\bagent_id\x18\x1b \x01(\tR\aagentId\x1a\x98\x03\n" +
	"\bTimeline\x129\n" +
	"\n" +
	...
	"finishedAt\x12L\n" +
	"\x14execution_started_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\x12executionStartedAt\x12N\n" +
	"\x15execution_finished_at\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\x13executionFinishedAt\"\\\n" +
	"\x05State\x12\v\n" +
	"\aPENDING\x10\x00\x12\f\n" +
	"\bENQUEUED\x10\x01\x12\r\n" +
	"\tSCHEDULED\x10\x02\x12\x0e\n" +
	"\n" +
	"DISPATCHED\x10\x05\x12\v\n" +
	"\aSTARTED\x10\x03\x12\f\n" +
	"\bFINISHED\x10\x04\"-\n" +
	"\x06Result\x12\n" +
	"\n" +
	...
	"\x03job\x18\x02 \x01(\v2\x1f.InternalApi.ServerFarm.Job.JobR\x03job\"\xe0\x05\n" +
	"\vListRequest\x12\x1b\n" +
	"\tpage_size\x18\x01 \x01(\x05R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x02 \x01(\tR\tpageToken\x12C\n" +
	"\x05order\x18\x03 \x01(\x0e2-.InternalApi.ServerFarm.Job.ListRequest.OrderR\x05order\x12D\n" +
	"\n" +
	"job_states\x18\x04 \x03(\x0e2%.InternalApi.ServerFarm.Job.Job.StateR\tjobStates\x12@\n" +
	"\x0efinished_at_gt\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\ffinishedAtGt\x12B\n" +
	"\x0ffinished_at_gte\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\rfinishedAtGte\x12'\n" +
	"\x0forganization_id\x18\a \x01(\tR\x0eorganizationId\x12&\n" +
	"\x0fonly_debug_jobs\x18\b \x01(\bR\ronlyDebugJobs\x12\x17\n" +
	"\appl_ids\x18\t \x03(\tR\x06pplIds\x12@\n" +
	"\x0ecreated_at_gte\x18\n" +
	" \x01(\v2\x1a.google.protobuf.TimestampR\fcreatedAtGte\x12@\n" +
	"\x0ecreated_at_lte\x18\v \x01(\v2\x1a.google.protobuf.TimestampR\fcreatedAtLte\x12\x1f\n" +
	"\vproject_ids\x18\r \x03(\tR\n" +
	"projectIds\x12#\n" +
	"\rmachine_types\x18\x0e \x03(\tR\fmachineTypes\"P\n" +
	"\x05Order\x12\x16\n" +
	"\x12BY_FINISH_TIME_ASC\x10\x00\x12\x19\n" +
	"\x15BY_CREATION_TIME_DESC\x10\x01\x12\x14\n" +
	"\x10BY_PRIORITY_DESC\x10\x02\"\xa0\x01\n" +
	"\fListResponse\x123\n" +
	"\x06status\x18\x01 \x01(\v2\x1b.InternalApi.ResponseStatusR\x06status\x123\n" +
	"\x04jobs\x18\x02 \x03(\v2\x1f.InternalApi.ServerFarm.Job.JobR\x04jobs\x12&\n" +
	"\x0fnext_page_token\x18\x03 \x01(\tR\rnextPageToken\"\x84\x04\n" +
	"\x18ListDebugSessionsRequest\x12\x1b\n" +
	"\tpage_size\x18\x01 \x01(\x05R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x02 \x01(\tR\tpageToken\x12P\n" +
	"\x05order\x18\x03 \x01(\x0e2:.InternalApi.ServerFarm.Job.ListDebugSessionsRequest.OrderR\x05order\x12W\n" +
	"\x14debug_session_states\x18\x04 \x03(\x0e2%.InternalApi.ServerFarm.Job.Job.StateR\x12debugSessionStates\x12B\n" +
	"\x05types\x18\x05 \x03(\x0e2,.InternalApi.ServerFarm.Job.DebugSessionTypeR\x05types\x12'\n" +
	"\x0forganization_id\x18\x06 \x01(\tR\x0eorganizationId\x12\x1d\n" +
	"\n" +
	"project_id\x18\a \x01(\tR\tprojectId\x12\x15\n" +
	"\x06job_id\x18\b \x01(\tR\x05jobId\x12\"\n" +
	"\rdebug_user_id\x18\t \x01(\tR\vdebugUserId\":\n" +
	"\x05Order\x12\x19\n" +
	"\x15BY_CREATION_TIME_DESC\x10\x00\x12\x16\n" +
	"\x12BY_FINISH_TIME_ASC\x10\x01\"\xc9\x01\n" +
	"\x19ListDebugSessionsResponse\x123\n" +
	"\x06status\x18\x01 \x01(\v2\x1b.InternalApi.ResponseStatusR\x06status\x12O\n" +
	"\x0edebug_sessions\x18\x02 \x03(\v2(.InternalApi.ServerFarm.Job.DebugSessionR\rdebugSessions\x12&\n" +
	"\x0fnext_page_token\x18\x03 \x01(\tR\rnextPageToken\"\xfe\x01\n" +
	"\fDebugSession\x12D\n" +
	"\rdebug_session\x18\x01 \x01(\v2\x1f.InternalApi.ServerFarm.Job.JobR\fdebugSession\x12@\n" +
	"\x04type\x18\x02 \x01(\x0e2,.InternalApi.ServerFarm.Job.DebugSessionTypeR\x04type\x12\"\n" +
	"\rdebug_user_id\x18\x03 \x01(\tR\vdebugUserId\x12B\n" +
	"\fdebugged_job\x18\x04 \x01(\v2\x1f.InternalApi.ServerFarm.Job.JobR\vdebuggedJob\"\xdc\x01\n" +
	"\fCountRequest\x12D\n" +
	"\n" +
	"job_states\x18\x04 \x03(\x0e2%.InternalApi.ServerFarm.Job.Job.StateR\tjobStates\x12B\n" +
	"\x0ffinished_at_gte\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\rfinishedAtGte\x12B\n" +
	"\x0ffinished_at_lte\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\rfinishedAtLte\"Z\n" +
	"\rCountResponse\x123\n" +
	"\x06status\x18\x01 \x01(\v2\x1b.InternalApi.ResponseStatusR\x06status\x12\x14\n" +
	"\x05count\x18\x02 \x01(\x05R\x05count\"\x8a\x01\n" +
	"\x13CountByStateRequest\x12\x15\n" +
	"\x06org_id\x18\x01 \x01(\tR\x05orgId\x12\x1d\n" +
	"\n" +
	"agent_type\x18\x02 \x01(\tR\tagentType\x12=\n" +
	"\x06states\x18\x03 \x03(\x0e2%.InternalApi.ServerFarm.Job.Job.StateR\x06states\"\xd0\x01\n" +
	"\x14CountByStateResponse\x12U\n" +
	"\x06counts\x18\x01 \x03(\v2=.InternalApi.ServerFarm.Job.CountByStateResponse.CountByStateR\x06counts\x1aa\n" +
	"\fCountByState\x12;\n" +
	"\x05state\x18\x01 \x01(\x0e2%.InternalApi.ServerFarm.Job.Job.StateR\x05state\x12\x14\n" +
	"\x05count\x18\x02 \x01(\x05R\x05count\"\xa8\x01\n" +
	"\x19TotalExecutionTimeRequest\x12\x15\n" +
	"\x06org_id\x18\x01 \x01(\tR\x05orgId\x12Z\n" +
	"\binterval\x18\x02 \x01(\x0e2>.InternalApi.ServerFarm.Job.TotalExecutionTimeRequest.IntervalR\binterval\"\x18\n" +
	"\bInterval\x12\f\n" +
	"\bLAST_DAY\x10\x00\"Q\n" +
	"\x1aTotalExecutionTimeResponse\x123\n" +
	"\x16total_duration_in_secs\x18\x01 \x01(\x03R\x13totalDurationInSecs\"G\n" +
	"\vStopRequest\x12\x15\n" +
	"\x06job_id\x18\x01 \x01(\tR\x05jobId\x12!\n" +
	"\frequester_id\x18\x02 \x01(\tR\vrequesterId\"C\n" +
	"\fStopResponse\x123\n" +
	"\x06status\x18\x01 \x01(\v2\x1b.InternalApi.ResponseStatusR\x06status\"/\n" +
	"\x16GetAgentPayloadRequest\x12\x15\n" +
	"\x06job_id\x18\x01 \x01(\tR\x05jobId\"3\n" +
	"\x17GetAgentPayloadResponse\x12\x18\n" +
	"\apayload\x18\x01 \x01(\tR\apayload\"A\n" +
	"\x0fCanDebugRequest\x12\x15\n" +
	"\x06job_id\x18\x01 \x01(\tR\x05jobId\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\tR\x06userId\"F\n" +
	"\x10CanDebugResponse\x12\x18\n" +
	"\aallowed\x18\x01 \x01(\bR\aallowed\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\"B\n" +
	"\x10CanAttachRequest\x12\x15\n" +
	"\x06job_id\x18\x01 \x01(\tR\x05jobId\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\tR\x06userId\"G\n" +
	"\x11CanAttachResponse\x12\x18\n" +
	"\aallowed\x18\x01 \x01(\bR\aallowed\x12\x18\n" +
	...
	"\bjob_spec\x18\x06 \x01(\v2#.InternalApi.ServerFarm.Job.JobSpecR\ajobSpec\x12%\n" +
	"\x0erestricted_job\x18\a \x01(\bR\rrestrictedJob\"x\n" +
	"\x0eCreateResponse\x123\n" +
	"\x06status\x18\x01 \x01(\v2\x1b.InternalApi.ResponseStatusR\x06status\x121\n" +
	"\x03job\x18\x02 \x01(\v2\x1f.InternalApi.ServerFarm.Job.JobR\x03job\"\xa9\n" +
	"\n" +
	"\aJobSpec\x12\x19\n" +
	"\bjob_name\x18\x01 \x01(\tR\ajobName\x12?\n" +
	"\x05agent\x18\x02 \x01(\v2).InternalApi.ServerFarm.Job.JobSpec.AgentR\x05agent\x12D\n" +
	"\asecrets\x18\x03 \x03(\v2*.InternalApi.ServerFarm.Job.JobSpec.SecretR\asecrets\x12E\n" +
	"\benv_vars\x18\x04 \x03(\v2*.InternalApi.ServerFarm.Job.JobSpec.EnvVarR\aenvVars\x12>\n" +
	"\x05files\x18\x05 \x03(\v2(.InternalApi.ServerFarm.Job.JobSpec.FileR\x05files\x12\x1a\n" +
	"\bcommands\x18\x06 \x03(\tR\bcommands\x128\n" +
	"\x18epilogue_always_commands\x18\a \x03(\tR\x16epilogueAlwaysCommands\x129\n" +
	"\x19epilogue_on_pass_commands\x18\b \x03(\tR\x16epilogueOnPassCommands\x129\n" +
	"\x19epilogue_on_fail_commands\x18\t \x03(\tR\x16epilogueOnFailCommands\x12\x1a\n" +
	"\bpriority\x18\n" +
	" \x01(\x05R\bpriority\x120\n" +
	"\x14execution_time_limit\x18\v \x01(\x05R\x12executionTimeLimit\x1a\xd2\x04\n" +
	"\x05Agent\x12K\n" +
	"\amachine\x18\x01 \x01(\v21.InternalApi.ServerFarm.Job.JobSpec.Agent.MachineR\amachine\x12S\n" +
	"\n" +
	"containers\x18\x02 \x03(\v23.InternalApi.ServerFarm.Job.JobSpec.Agent.ContainerR\n" +
	"containers\x12g\n" +
	"\x12image_pull_secrets\x18\x03 \x03(\v29.InternalApi.ServerFarm.Job.JobSpec.Agent.ImagePullSecretR\x10imagePullSecrets\x1a8\n" +
	"\aMachine\x12\x12\n" +
	"\x04type\x18\x01 \x01(\tR\x04type\x12\x19\n" +
	"\bos_image\x18\x02 \x01(\tR\aosImage\x1a\xdc\x01\n" +
	"\tContainer\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x14\n" +
	"\x05image\x18\x02 \x01(\tR\x05image\x12\x18\n" +
	"\acommand\x18\x03 \x01(\tR\acommand\x12E\n" +
	"\benv_vars\x18\x04 \x03(\v2*.InternalApi.ServerFarm.Job.JobSpec.EnvVarR\aenvVars\x12D\n" +
	"\asecrets\x18\x05 \x03(\v2*.InternalApi.ServerFarm.Job.JobSpec.SecretR\asecrets\x1a%\n" +
	...
	"\x11artifact_store_id\x18\x04 \x01(\tR\x0fartifactStoreId\x12\x1d\n" +
	"\n" +
	"project_id\x18\x05 \x01(\tR\tprojectId*(\n" +
	"\x10DebugSessionType\x12\a\n" +
	"\x03JOB\x10\x00\x12\v\n" +
	"\aPROJECT\x10\x012\xb1\t\n" +
	"\n" +
	"JobService\x12e\n" +
	"\bDescribe\x12+.InternalApi.ServerFarm.Job.DescribeRequest\x1a,.InternalApi.ServerFarm.Job.DescribeResponse\x12Y\n" +
	"\x04List\x12'.InternalApi.ServerFarm.Job.ListRequest\x1a(.InternalApi.ServerFarm.Job.ListResponse\x12\x80\x01\n" +
	"\x11ListDebugSessions\x124.InternalApi.ServerFarm.Job.ListDebugSessionsRequest\x1a5.InternalApi.ServerFarm.Job.ListDebugSessionsResponse\x12\\\n" +
	"\x05Count\x12(.InternalApi.ServerFarm.Job.CountRequest\x1a).InternalApi.ServerFarm.Job.CountResponse\x12q\n" +
	"\fCountByState\x12/.InternalApi.ServerFarm.Job.CountByStateRequest\x1a0.InternalApi.ServerFarm.Job.CountByStateResponse\x12Y\n" +
	"\x04Stop\x12'.InternalApi.ServerFarm.Job.StopRequest\x1a(.InternalApi.ServerFarm.Job.StopResponse\x12\x83\x01\n" +
	"\x12TotalExecutionTime\x125.InternalApi.ServerFarm.Job.TotalExecutionTimeRequest\x1a6.InternalApi.ServerFarm.Job.TotalExecutionTimeResponse\x12z\n" +
	"\x0fGetAgentPayload\x122.InternalApi.ServerFarm.Job.GetAgentPayloadRequest\x1a3.InternalApi.ServerFarm.Job.GetAgentPayloadResponse\x12e\n" +
	"\bCanDebug\x12+.InternalApi.ServerFarm.Job.CanDebugRequest\x1a,.InternalApi.ServerFarm.Job.CanDebugResponse\x12h\n" +
	"\tCanAttach\x12,.InternalApi.ServerFarm.Job.CanAttachRequest\x1a-.InternalApi.ServerFarm.Job.CanAttachResponse\x12_\n" +
	"\x06Create\x12).InternalApi.ServerFarm.Job.CreateRequest\x1a*.InternalApi.ServerFarm.Job.CreateResponseBRZPgithub.com/semaphoreio/semaphore/artifacthub/pkg/api/descriptors/server_farm.jobb\x06proto3"

var (
	file_server_farm_job_proto_rawDescOnce sync.Once
	file_server_farm_job_proto_rawDescData []byte
)

func file_server_farm_job_proto_rawDescGZIP() []byte {
	file_server_farm_job_proto_rawDescOnce.Do(func() {
		file_server_farm_job_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_server_farm_job_proto_rawDesc), len(file_server_farm_job_proto_rawDesc)))
	})
	return file_server_farm_job_proto_rawDescData
}

var file_server_farm_job_proto_enumTypes = make([]protoimpl.EnumInfo, 6)
var file_server_farm_job_proto_msgTypes = make([]protoimpl.MessageInfo, 35)
var file_server_farm_job_proto_goTypes = []any{
	...
	(*JobDeleted)(nil),                        // 31: InternalApi.ServerFarm.Job.JobDeleted
	(*Job_Timeline)(nil),                      // 32: InternalApi.ServerFarm.Job.Job.Timeline
	(*CountByStateResponse_CountByState)(nil), // 33: InternalApi.ServerFarm.Job.CountByStateResponse.CountByState
	(*JobSpec_Agent)(nil),                     // 34: InternalApi.ServerFarm.Job.JobSpec.Agent
	(*JobSpec_Secret)(nil),                    // 35: InternalApi.ServerFarm.Job.JobSpec.Secret
	(*JobSpec_EnvVar)(nil),                    // 36: InternalApi.ServerFarm.Job.JobSpec.EnvVar
	(*JobSpec_File)(nil),                      // 37: InternalApi.ServerFarm.Job.JobSpec.File
	(*JobSpec_Agent_Machine)(nil),             // 38: InternalApi.ServerFarm.Job.JobSpec.Agent.Machine
	(*JobSpec_Agent_Container)(nil),           // 39: InternalApi.ServerFarm.Job.JobSpec.Agent.Container
	(*JobSpec_Agent_ImagePullSecret)(nil),     // 40: InternalApi.ServerFarm.Job.JobSpec.Agent.ImagePullSecret
	(*response_status.ResponseStatus)(nil),    // 41: InternalApi.ResponseStatus
	(*timestamp.Timestamp)(nil),               // 42: google.protobuf.Timestamp
}
var file_server_farm_job_proto_depIdxs = []int32{
	32, // 0: InternalApi.ServerFarm.Job.Job.timeline:type_name -> InternalApi.ServerFarm.Job.Job.Timeline
	...
	41, // 3: InternalApi.ServerFarm.Job.DescribeResponse.status:type_name -> InternalApi.ResponseStatus
	...
	42, // 7: InternalApi.ServerFarm.Job.ListRequest.finished_at_gt:type_name -> google.protobuf.Timestamp
	42, // 8: InternalApi.ServerFarm.Job.ListRequest.finished_at_gte:type_name -> google.protobuf.Timestamp
	42, // 9: InternalApi.ServerFarm.Job.ListRequest.created_at_gte:type_name -> google.protobuf.Timestamp
	42, // 10: InternalApi.ServerFarm.Job.ListRequest.created_at_lte:type_name -> google.protobuf.Timestamp
	41, // 11: InternalApi.ServerFarm.Job.ListResponse.status:type_name -> InternalApi.ResponseStatus
	...
	41, // 16: InternalApi.ServerFarm.Job.ListDebugSessionsResponse.status:type_name -> InternalApi.ResponseStatus
	...
	42, // 22: InternalApi.ServerFarm.Job.CountRequest.finished_at_gte:type_name -> google.protobuf.Timestamp
	42, // 23: InternalApi.ServerFarm.Job.CountRequest.finished_at_lte:type_name -> google.protobuf.Timestamp
	41, // 24: InternalApi.ServerFarm.Job.CountResponse.status:type_name -> InternalApi.ResponseStatus
	1,  // 25: InternalApi.ServerFarm.Job.CountByStateRequest.states:type_name -> InternalApi.ServerFarm.Job.Job.State
	33, // 26: InternalApi.ServerFarm.Job.CountByStateResponse.counts:type_name -> InternalApi.ServerFarm.Job.CountByStateResponse.CountByState
	...
	41, // 28: InternalApi.ServerFarm.Job.StopResponse.status:type_name -> InternalApi.ResponseStatus
	30, // 29: InternalApi.ServerFarm.Job.CreateRequest.job_spec:type_name -> InternalApi.ServerFarm.Job.JobSpec
	41, // 30: InternalApi.ServerFarm.Job.CreateResponse.status:type_name -> InternalApi.ResponseStatus
	7,  // 31: InternalApi.ServerFarm.Job.CreateResponse.job:type_name -> InternalApi.ServerFarm.Job.Job
	34, // 32: InternalApi.ServerFarm.Job.JobSpec.agent:type_name -> InternalApi.ServerFarm.Job.JobSpec.Agent
	35, // 33: InternalApi.ServerFarm.Job.JobSpec.secrets:type_name -> InternalApi.ServerFarm.Job.JobSpec.Secret
	36, // 34: InternalApi.ServerFarm.Job.JobSpec.env_vars:type_name -> InternalApi.ServerFarm.Job.JobSpec.EnvVar
	37, // 35: InternalApi.ServerFarm.Job.JobSpec.files:type_name -> InternalApi.ServerFarm.Job.JobSpec.File
	42, // 36: InternalApi.ServerFarm.Job.JobDeleted.deleted_at:type_name -> google.protobuf.Timestamp
	42, // 37: InternalApi.ServerFarm.Job.Job.Timeline.created_at:type_name -> google.protobuf.Timestamp
	42, // 38: InternalApi.ServerFarm.Job.Job.Timeline.enqueued_at:type_name -> google.protobuf.Timestamp
	42, // 39: InternalApi.ServerFarm.Job.Job.Timeline.started_at:type_name -> google.protobuf.Timestamp
	42, // 40: InternalApi.ServerFarm.Job.Job.Timeline.finished_at:type_name -> google.protobuf.Timestamp
	42, // 41: InternalApi.ServerFarm.Job.Job.Timeline.execution_started_at:type_name -> google.protobuf.Timestamp
	42, // 42: InternalApi.ServerFarm.Job.Job.Timeline.execution_finished_at:type_name -> google.protobuf.Timestamp
	1,  // 43: InternalApi.ServerFarm.Job.CountByStateResponse.CountByState.state:type_name -> InternalApi.ServerFarm.Job.Job.State
	38, // 44: InternalApi.ServerFarm.Job.JobSpec.Agent.machine:type_name -> InternalApi.ServerFarm.Job.JobSpec.Agent.Machine
	39, // 45: InternalApi.ServerFarm.Job.JobSpec.Agent.containers:type_name -> InternalApi.ServerFarm.Job.JobSpec.Agent.Container
	40, // 46: InternalApi.ServerFarm.Job.JobSpec.Agent.image_pull_secrets:type_name -> InternalApi.ServerFarm.Job.JobSpec.Agent.ImagePullSecret
	36, // 47: InternalApi.ServerFarm.Job.JobSpec.Agent.Container.env_vars:type_name -> InternalApi.ServerFarm.Job.JobSpec.EnvVar
	35, // 48: InternalApi.ServerFarm.Job.JobSpec.Agent.Container.secrets:type_name -> InternalApi.ServerFarm.Job.JobSpec.Secret
	6,  // 49: InternalApi.ServerFarm.Job.JobService.Describe:input_type -> InternalApi.ServerFarm.Job.DescribeRequest
	9,  // 50: InternalApi.ServerFarm.Job.JobService.List:input_type -> InternalApi.ServerFarm.Job.ListRequest
	11, // 51: InternalApi.ServerFarm.Job.JobService.ListDebugSessions:input_type -> InternalApi.ServerFarm.Job.ListDebugSessionsRequest
	14, // 52: InternalApi.ServerFarm.Job.JobService.Count:input_type -> InternalApi.ServerFarm.Job.CountRequest
	16, // 53: InternalApi.ServerFarm.Job.JobService.CountByState:input_type -> InternalApi.ServerFarm.Job.CountByStateRequest
	20, // 54: InternalApi.ServerFarm.Job.JobService.Stop:input_type -> InternalApi.ServerFarm.Job.StopRequest
	18, // 55: InternalApi.ServerFarm.Job.JobService.TotalExecutionTime:input_type -> InternalApi.ServerFarm.Job.TotalExecutionTimeRequest
	22, // 56: InternalApi.ServerFarm.Job.JobService.GetAgentPayload:input_type -> InternalApi.ServerFarm.Job.GetAgentPayloadRequest
	24, // 57: InternalApi.ServerFarm.Job.JobService.CanDebug:input_type -> InternalApi.ServerFarm.Job.CanDebugRequest
	26, // 58: InternalApi.ServerFarm.Job.JobService.CanAttach:input_type -> InternalApi.ServerFarm.Job.CanAttachRequest
	28, // 59: InternalApi.ServerFarm.Job.JobService.Create:input_type -> InternalApi.ServerFarm.Job.CreateRequest
	8,  // 60: InternalApi.ServerFarm.Job.JobService.Describe:output_type -> InternalApi.ServerFarm.Job.DescribeResponse
	10, // 61: InternalApi.ServerFarm.Job.JobService.List:output_type -> InternalApi.ServerFarm.Job.ListResponse
	12, // 62: InternalApi.ServerFarm.Job.JobService.ListDebugSessions:output_type -> InternalApi.ServerFarm.Job.ListDebugSessionsResponse
	15, // 63: InternalApi.ServerFarm.Job.JobService.Count:output_type -> InternalApi.ServerFarm.Job.CountResponse
	17, // 64: InternalApi.ServerFarm.Job.JobService.CountByState:output_type -> InternalApi.ServerFarm.Job.CountByStateResponse
	21, // 65: InternalApi.ServerFarm.Job.JobService.Stop:output_type -> InternalApi.ServerFarm.Job.StopResponse
	19, // 66: InternalApi.ServerFarm.Job.JobService.TotalExecutionTime:output_type -> InternalApi.ServerFarm.Job.TotalExecutionTimeResponse
	23, // 67: InternalApi.ServerFarm.Job.JobService.GetAgentPayload:output_type -> InternalApi.ServerFarm.Job.GetAgentPayloadResponse
	25, // 68: InternalApi.ServerFarm.Job.JobService.CanDebug:output_type -> InternalApi.ServerFarm.Job.CanDebugResponse
	27, // 69: InternalApi.ServerFarm.Job.JobService.CanAttach:output_type -> InternalApi.ServerFarm.Job.CanAttachResponse
	29, // 70: InternalApi.ServerFarm.Job.JobService.Create:output_type -> InternalApi.ServerFarm.Job.CreateResponse
...
func file_server_farm_job_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_server_farm_job_proto_rawDesc), len(file_server_farm_job_proto_rawDesc)),
			NumEnums:      6,
			NumMessages:   35,
			NumExtensions: 0,
			NumServices:   1,
