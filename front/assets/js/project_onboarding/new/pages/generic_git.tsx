          ...
          <div className="mt2">
            ...
            <div className="flex items-center">
              ...
              <button className="btn btn-primary flex" onClick={createRepository} disabled={loading}>
                {loading && (
                  <toolbox.Asset path="images/spinner-2.svg" style={{ width: `20px`, height: `20px`, margin: `0` }}/>
                )}
                {!loading && <span>✓</span>}
              </button>
            </div>
    ...
    void url.call().then((response) => {
      if (response.data) {
        setRepository((prev) => ({
          ...
          webhookEndpoint: response.data.endpoint,
        }));
      }
    });
  };
      ...
      <div>
        {repository.connected && (
          <div className="mv3 bg-washed-yellow pa2 br2">
            ...
            <p className="mb0">
              We see that you&apos;ve already generated a webhook script. If you want to regenerate it - click the
              button below.
            </p>
          </div>
        )}
      ...
      <div className="w-two-thirds">
        <div>
          <p>
            ...
            <span className="bg-washed-yellow ph2 ba b--black-075 br3">post-receive</span> Git hook. This hook sends
            events to Semaphore every time you push new commits.
          </p>
        </div>
        {!repository.webhookSecret && (
          <p>We will generate a script for you, which you can install in your Git repository.</p>
        )}
        {repository.webhookSecret && (
          <>
            <p>
              Copy the following <span className="bg-washed-yellow ph2 ba b--black-075 br3">post-receive</span> script
              into the <span className="bg-washed-yellow ph2 ba b--black-075 br3">hooks</span> directory of your{` `}
              <strong>bare</strong> Git repository:
            </p>
        ...
        {!repository.agentName && (
          <div className="mb4">
            ...
            <div className="mv3 bg-washed-yellow pa2 br2">
              ...
              <p className="mb0">
                The initialization job is responsible for setting up the environment for your workflow. Please add an
                agent configuration in your
                <a
