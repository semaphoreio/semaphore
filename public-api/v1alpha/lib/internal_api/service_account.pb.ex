...
defmodule InternalApi.ServiceAccount.ServiceAccountService.Service do
  ...
  rpc :Create, InternalApi.ServiceAccount.CreateRequest, InternalApi.ServiceAccount.CreateResponse
  ...
  rpc :Update, InternalApi.ServiceAccount.UpdateRequest, InternalApi.ServiceAccount.UpdateResponse
