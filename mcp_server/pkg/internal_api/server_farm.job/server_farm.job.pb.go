...
type ListRequest struct {
	...
	FinishedAtGt  *timestamppb.Timestamp `protobuf:"bytes,5,opt,name=finished_at_gt,json=finishedAtGt,proto3" json:"finished_at_gt,omitempty"`
	FinishedAtGte *timestamppb.Timestamp `protobuf:"bytes,6,opt,name=finished_at_gte,json=finishedAtGte,proto3" json:"finished_at_gte,omitempty"`
	...
	CreatedAtGte *timestamppb.Timestamp `protobuf:"bytes,10,opt,name=created_at_gte,json=createdAtGte,proto3" json:"created_at_gte,omitempty"`
	CreatedAtLte *timestamppb.Timestamp `protobuf:"bytes,11,opt,name=created_at_lte,json=createdAtLte,proto3" json:"created_at_lte,omitempty"`
...
func (x *ListRequest) GetFinishedAtGt() *timestamppb.Timestamp {
	if x != nil {
...
func (x *ListRequest) GetFinishedAtGte() *timestamppb.Timestamp {
	if x != nil {
...
func (x *ListRequest) GetCreatedAtGte() *timestamppb.Timestamp {
	if x != nil {
...
func (x *ListRequest) GetCreatedAtLte() *timestamppb.Timestamp {
	if x != nil {
...
type CountRequest struct {
	...
	FinishedAtGte *timestamppb.Timestamp `protobuf:"bytes,1,opt,name=finished_at_gte,json=finishedAtGte,proto3" json:"finished_at_gte,omitempty"`
	FinishedAtLte *timestamppb.Timestamp `protobuf:"bytes,2,opt,name=finished_at_lte,json=finishedAtLte,proto3" json:"finished_at_lte,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CountRequest) GetFinishedAtGte() *timestamppb.Timestamp {
	if x != nil {
		return x.FinishedAtGte
	}
	return nil
...
func (x *CountRequest) GetFinishedAtLte() *timestamppb.Timestamp {
	if x != nil {
...
func (x *JobDeleted) GetDeletedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.DeletedAt
	}
	return nil
...
type Job_Timeline struct {
	...
	ExecutionStartedAt *timestamppb.Timestamp `protobuf:"bytes,5,opt,name=execution_started_at,json=executionStartedAt,proto3" json:"execution_started_at,omitempty"`
	// Timestamp when the job was finished on the machine.
	ExecutionFinishedAt *timestamppb.Timestamp `protobuf:"bytes,6,opt,name=execution_finished_at,json=executionFinishedAt,proto3" json:"execution_finished_at,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *Job_Timeline) GetCreatedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
func (x *Job_Timeline) GetEnqueuedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.EnqueuedAt
	}
	return nil
...
func (x *Job_Timeline) GetStartedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.StartedAt
	}
	return nil
...
func (x *Job_Timeline) GetFinishedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.FinishedAt
	}
	return nil
...
func (x *Job_Timeline) GetExecutionStartedAt() *timestamppb.Timestamp {
	if x != nil {
...
func (x *Job_Timeline) GetExecutionFinishedAt() *timestamppb.Timestamp {
	if x != nil {
...
var file_server_farm_job_proto_rawDesc = []byte{
	...
	0x2e, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x46, 0x61, 0x72, 0x6d, 0x2e, 0x4a, 0x6f, 0x62, 0x2e,
	0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x4e,
	0x5a, 0x4c, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x73, 0x65, 0x6d,
	...
	0x67, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x5f, 0x61, 0x70, 0x69, 0x2f, 0x73,
	0x65, 0x72, 0x76, 0x65, 0x72, 0x5f, 0x66, 0x61, 0x72, 0x6d, 0x2e, 0x6a, 0x6f, 0x62, 0x62, 0x06,
