...
// UnimplementedNotificationsApiServer should be embedded to have
...
func (UnimplementedNotificationsApiServer) testEmbeddedByValue() {}
...
func RegisterNotificationsApiServer(s grpc.ServiceRegistrar, srv NotificationsApiServer) {
	// If the following call pancis, it indicates UnimplementedNotificationsApiServer was
